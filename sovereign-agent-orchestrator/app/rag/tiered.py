...
class TieredRagService:
    def __init__(self, tier_urls, ollama_base_url, embedding_model, vision_model, embedding_dimensions=768, keep_alive=None):
        self.services = {
            tier: RagService(url, ollama_base_url, embedding_model, vision_model, embedding_dimensions, keep_alive)
